...
var CInventory = Class.create( {
		...
		for( var sCategoryName in this.tags )
		{
			...
			for( var index in rgCategoryTags )
			{
				...
				if ( ++cTagsDisplayed == 5 && cTagsTotal > 7 )
				{
					...
					elExpandTags.update( '+ Περισσότερα' );
	...
	BuildUnknownItemElement: function( appid, contextid, itemid )
	{
		...
		elItem.rgItem = { unknown: true, id: itemid, appid: this.appid, contextid: this.contextid, element: elItem, name: 'Άγνωστο αντικείμενο ' + itemid, descriptions: [], fraudwarnings: [ 'Αδύνατη η ανάκτηση πληροφοριών σχετικά με το αντικείμενο.' ] };
			...
			if ( bUserAction )
			{
				...
				if ( $BtnAddToTrade.length && typeof OnDoubleClickItem != 'undefined' )
				{
					...
					if ( bInTrade )
					{
						...
						$BtnAddToTrade.children('span' ).text( 'Αφαίρεση από την ανταλλαγή' );
					}
					else
					{
						$BtnAddToTrade.removeClass('btn_grey_white_innerfade' ).addClass('btn_green_white_innerfade');
						$BtnAddToTrade.children('span' ).text( 'Προσθήκη για ανταλλαγή' );
					}
	...
	LoadContexts: function( rgAppContextData )
	{
		for ( var appid in rgAppContextData )
		{
			...
			if ( rgContextIds.length > 1 )
			{
				...
				var templAllContextName = new Template( 'Όλα τα αντικείμενα #{appname}');
	...
	OnInventoryLoadFailed: function( transport, appid, contextid )
	{
		...
		if ( transport.responseJSON && transport.responseJSON.busy )
		{
			if ( !elFailedInventory )
			{
				...
				alert( 'Tα αντικείμενά σας δεν είναι διαθέσιμα αυτή τη στιγμή. Παρακαλούμε δοκιμάστε ξανά αργότερα.' );
			}
		}
...
var g_rgEconomyDisplay = {"440":{"howtoget":"\u039c\u03c0\u03bf\u03c1\u03b5\u03af\u03c4\u03b5 \u03bd\u03b1 \u03c4\u03b1 \u03b1\u03c0\u03bf\u03ba\u03c4\u03ae\u03c3\u03b5\u03c4\u03b5 \u03b4\u03c9\u03c1\u03b5\u03ac\u03bd \u03bc\u03b5 \u03c4\u03bf \u03bd\u03b1 \u03c4\u03b1 \u03b2\u03c1\u03b5\u03af\u03c4\u03b5 \u03c3\u03c4\u03bf \u03c0\u03b1\u03b9\u03c7\u03bd\u03af\u03b4\u03b9, \u03b1\u03c0\u03cc \u03c4\u03bf \u039a\u03b1\u03c4\u03ac\u03c3\u03c4\u03b7\u03bc\u03b1 Mann Co.,  \u03ae \u03bd\u03b1 \u03b1\u03bd\u03c4\u03b1\u03bb\u03bb\u03ac\u03be\u03b5\u03c4\u03b5 \u03b3\u03b9\u03b1 \u03b1\u03c5\u03c4\u03ac \u03bc\u03b5 \u03c6\u03af\u03bb\u03bf\u03c5\u03c2."},"620":{"howtoget":"\u039c\u03c0\u03bf\u03c1\u03b5\u03af\u03c4\u03b5 \u03bd\u03b1 \u03c4\u03b1 \u03b1\u03c0\u03bf\u03ba\u03c4\u03ae\u03c3\u03b5\u03c4\u03b5 \u03b1\u03c0\u03cc \u03c4\u03bf \u03ba\u03b1\u03c4\u03ac\u03c3\u03c4\u03b7\u03bc\u03b1 \u03b5\u03bd\u03c4\u03cc\u03c2 \u03c4\u03bf\u03c5 Portal 2 \u03ae \u03bd\u03b1 \u03b1\u03bd\u03c4\u03b1\u03bb\u03bb\u03ac\u03be\u03b5\u03c4\u03b5 \u03b3\u03b9\u03b1 \u03b1\u03c5\u03c4\u03ac \u03bc\u03b5 \u03c6\u03af\u03bb\u03bf\u03c5\u03c2."},"753":{"1":{"howtoget":"\u039c\u03c0\u03bf\u03c1\u03b5\u03af\u03c4\u03b5 \u03bd\u03b1 \u03c0\u03ac\u03c1\u03b5\u03c4\u03b5 \u03b5\u03c0\u03b9\u03c0\u03bb\u03ad\u03bf\u03bd \u03b1\u03bd\u03c4\u03af\u03b3\u03c1\u03b1\u03c6\u03b1 \u03c0\u03b1\u03b9\u03c7\u03bd\u03b9\u03b4\u03b9\u03ce\u03bd \u03c3\u03b5 \u03b5\u03b9\u03b4\u03b9\u03ba\u03ad\u03c2 \u03c0\u03c1\u03bf\u03c3\u03c6\u03bf\u03c1\u03ad\u03c2, \u03ae \u03cc\u03c4\u03b1\u03bd \u03b1\u03b3\u03bf\u03c1\u03ac\u03c3\u03b5\u03c4\u03b5 \u03ad\u03bd\u03b1 \u03c0\u03b1\u03b9\u03c7\u03bd\u03af\u03b4\u03b9 \u03b1\u03c0\u03cc \u03c4\u03bf \u03ba\u03b1\u03c4\u03ac\u03c3\u03c4\u03b7\u03bc\u03b1 \u03c4\u03bf\u03c5 Steam \u03ba\u03b1\u03b9 \u03b5\u03c0\u03b9\u03bb\u03ad\u03be\u03b5\u03c4\u03b5 \"\u0391\u03b3\u03bf\u03c1\u03ac \u03c9\u03c2 \u0394\u03ce\u03c1\u03bf\" \u03ba\u03b1\u03c4\u03ac \u03c4\u03b7\u03bd \u03bf\u03bb\u03bf\u03ba\u03bb\u03ae\u03c1\u03c9\u03c3\u03b7 \u03b1\u03b3\u03bf\u03c1\u03ac\u03c2."}},"99900":{"logo":"https:\/\/community.cloudflare.steamstatic.com\/public\/images\/economy\/applogos\/99900.png"},"99920":{"logo":"https:\/\/community.cloudflare.steamstatic.com\/public\/images\/economy\/applogos\/99900.png"}};
...
var HoverCurrencyFromTemplate = new Template( '<span style="#{currencystyle}">#{amount}</span> απ\' τα #{contextname}');
...
function BuildHover( prefix, item, owner )
{
	...
	if ( elFraudWarnings )
	{
		...
		if ( item.fraudwarnings || ( g_bIsInventoryPage && item.is_currency ) )
		{
			...
			{
				var warning = $J( '<div/>' );
				warning.text( 'Το ποσό αυτό είναι ιδιωτικό και εμφανίζεται μόνο σε εσάς.' );
...
function PopulateScrapAction( elActions, elScrapAmount, elScrapLink, item, appid, item_type, border_color )
{
	...
	$J.ajax({
		...
		success: function( response )
		{
			...
			{
				elScrapAmount.update( '%s πετράδια'.replace( /%s/, response.goo_value  ) );
...
function PopulateMarketActions( elActions, item )
{
	...
	if ( ( typeof(g_bViewingOwnProfile) != 'undefined' && g_bViewingOwnProfile ) || bIsTrading )
	{
		...
		elMarketLink.update( 'Προβολή στην Αγορά Κοινότητας' );
		...
		elPriceInfoContent.update( '<img src="https://community.cloudflare.steamstatic.com/public/images/login/throbber.gif" alt="Επεξεργασία...">' );
		...
		new Ajax.Request( 'https://steamcommunity.com/market/priceoverview/', {
				...
				onSuccess: function( transport ) {
					if ( transport.responseJSON && transport.responseJSON.success )
					{
						...
						{
							strInfo += 'Τιμή έναρξης: ' + transport.responseJSON.lowest_price + '<br>'
						}
						else
						{
							strInfo += 'Δεν υπάρχουν διαθέσιμες καταχωρήσεις για αυτό το αντικείμενο.' + '<br>';
						}

						if ( transport.responseJSON.volume )
						{
							var strVolume = '%1$s πωλήσεις στις τελευταίες 24 ώρες';
							strVolume = strVolume.replace( '%1$s', transport.responseJSON.volume );
							//strInfo += 'Μέση τιμή: ' + transport.responseJSON.median_price + '<br>';
							strInfo += 'Πωλήσεις: ' + strVolume + '<br>';
						}
		...
		if ( !bIsTrading )
		{
			var elSellButton = CreateMarketActionButton('green', 'javascript:SellCurrentSelection()', 'Πώληση' );
...
function SellCurrentSelection()
{
	...
	{
		MessageDialog.Show(
			'Δεν μπορείτε να πουλήσετε αντικείμενα στην Αγορά Κοινότητας μέχρι να <a href="https://store.steampowered.com/steamaccount/addfunds" target="_top">προσθέσετε χρήματα στο Πορτοφόλι Steam</a> ή να κάνετε μια αγορά στο κατάστημα Steam όπου θα παράσχετε τη διεύθυνση τιμολόγησής σας.',
			'Δεν είναι δυνατή η πώληση του αντικειμένου'
		);
	}
	else
	{
...
SellItemDialog = {
	...
	Show: function ( item ) {
		...
		$('market_sell_dialog_title').update( 'Προσφέρετε ένα αντικείμενο για πώληση' );
	...
	OnAccept: function( event ) {
		...
		{
			this.DisplayError( 'Πρέπει να αποδεχθείτε τους όρους του Συμφωνητικού Συνδρομητή του Steam για να πουλήσετε αυτό το αντικείμενο.' );
			return;
		}
		...
		if ( quantity < 1 || quantity > this.m_item.amount )
		{
			...
			this.DisplayError( 'Πρέπει να εισάγετε μια έγκυρη ποσότητα.' );
			return;
		}
		...
		if ( buyerPrice > g_rgWalletInfo['wallet_trade_max_balance'] || price > g_rgWalletInfo['wallet_trade_max_balance'] )
		{
			...
			var strError = ' Η τιμή που εισαγάγατε υπερβαίνει το μέγιστο όριο των %1$s.'
		...
		{
			$('market_sell_currency_input').style.borderColor = 'red';
			this.DisplayError( 'Πρέπει να εισαγάγετε μια έγκυρη τιμή.' );
			return;
		}
		...
		$('market_sell_dialog_title').update( 'Επιβεβαιώστε την τιμή της πώλησης' );
	...
	OnSuccess: function( transport ) {
		...
		if ( transport.responseJSON )
		{
			...
			if ( transport.responseJSON.requires_confirmation )
			{
				...
				{
					strText = 'Για να καταχωρήστε αυτό το αντικείμενο στην Αγορά Κοινότητας, θα πρέπει να επαληθεύσετε την καταχώρηση στην εφαρμογή κινητού Steam σας. Μπορείτε να την επαληθεύσετε εκκινώντας την εφαρμογή και μεταβαίνοντας στη σελίδα επιβεβαιώσεις από το μενού.' +
							'<br><br>' +
							'Εάν δεν βλέπετε την επιλογή Επιβεβαιώσεις στο κεντρικό μενού της εφαρμογής, σιγουρευτείτε ότι έχετε την τελευταία έκδοση.';

				}
				else
				{
					strText = 'Για να καταχωρήσετε αυτό το αντικείμενο στην Αγορά κοινότητας, θα πρέπει να ολοκληρώσετε ένα επιπρόσθετο βήμα επαλήθευσης. Ένα email έχει αποσταλεί στη διεύθυνσή σας (που λήγει σε «%s») με επιπλέον οδηγίες.'.replace( /%s/, transport.responseJSON.email_domain );
				}

				ShowAlertDialog(
						'Απαιτείται επιπλέον επιβεβαίωση',
						strText
				);
			}
			else
		...
		{
			this.DisplayError( 'Προέκυψε πρόβλημα κατά την καταχώρηση αγγελίας για το αντικείμενό σας. Ανανεώστε τη σελίδα και προσπαθήστε ξανά.' );
		}
	},
...
function SelectItemDialogOnSelect()
{
	...
	{
		alert( 'Παρουσιάστηκε ένα πρόβλημα κατά την αποθήκευση της επιλογής σας. Παρακαλούμε δοκιμάστε ξανά αργότερα.' );
	}
}
...
function CreatePriceHistoryGraph( line1, numYAxisTicks, strFormatPrefix, strFormatSuffix )
{
	var plot = $J.jqplot('pricehistory', [line1], {
		title:{text: 'Μέση τιμή πώλησης', textAlign: 'left' },
		...
		highlighter: {
			...
			fadeTooltip: true,
            yvalues: 2,
            formatString: '<strong>%s</strong><br>%s<br>%d πωλήθηκαν'
		},
...
{
	var $Dialog = $J('<div/>');
	$Dialog.append( $J('<div/>', {'class': 'trade_scam_report_label' }).html( 'Χρησιμοποιήστε αυτό για να αναφέρετε τον %s στο Steam για απόπειρα απάτης.<br><br>Παρακαλούμε παρέχετε μια σύντομη περιγραφή:'.replace( /%s/, strPersonaName ) ) );
	var $TextArea = $J('<textarea/>', {'rows': 3, 'cols': 26 });
	$Dialog.append( $J('<div/>', {'class': 'gray_bevel fullwidth' }).append( $TextArea ) );
	var Modal = ShowConfirmDialog( 'Αναφορά απάτης', $Dialog, 'Αναφορά απάτης').done( function() {
		if ( !$TextArea.val() )
		{
			ShowAlertDialog( 'Αναφορά απάτης', 'Απαιτείται μια περιγραφή.' );
			return;
		}
		...
		$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', rgParams).done( function() {
			ShowAlertDialog( 'Σας ευχαριστούμε!', 'Η αναφορά σας υποβλήθηκε και θα εξεταστεί από την Υποστήριξη Steam.' );
		}).fail( function() {
			ShowAlertDialog( 'Αναφορά απάτης', 'Υπήρξε ένα πρόβλημα με την αποθήκευση της αναφοράς σας. Παρακαλούμε δοκιμάστε ξανά αργότερα.' );
		});
	} );
...
function ShowEscrowExplanationDialog( bAddSteamGuardLink )
{
	...
	description.append( '<div class="escrow_explanation_q">Τι είναι η αναμονή ανταλλαγής ή Αγοράς;</div>' );
	description.append( '<div class="escrow_explanation_a">Η αναμονή είναι μια χρονική περίοδος κατά την οποία τα αντικείμενα κρατούνται από το Steam πριν ολοκληρωθεί η ανταλλαγή ή η δημιουργία αγγελίας στην Αγορά.</div>' );

	description.append( '<div class="escrow_explanation_q">Οι αναμονές αντικειμένων προστατεύουν τα αντικείμενά σας</div>' );
	description.append( '<div class="escrow_explanation_a">Οι λογαριασμοί Steam είναι πολύτιμοι, ειδικά αν έχουν αντικείμενα αξίας. Εάν δεν έχετε προστατεύσει το λογαριασμό σας με μία πραγματική συσκευή (χρησιμοποιώντας τον επαληθευτή κινητού Steam Guard), η αναμονή ανταλλαγής θα σας δώσει χρόνο να ανακαλύψετε ότι ο λογαριασμός σας έχει παραβιαστεί και να αποτρέψετε τη μεταφορά αντικειμένων εκτός του λογαριασμού σας.</div>' );

	description.append( '<div class="escrow_explanation_q">Μια καθυστέρηση για να προλάβετε και να σταματήσετε την κλοπή αντικειμένων</div>' );
	description.append( '<div class="escrow_explanation_a">Αν κάποιος χρήστης που ανταλλάζει ή πουλάει αντικείμενα δεν έχει προστατευμένο το λογαριασμό του με τον επαληθευτή κινητού τις τελευταίες 7 ημέρες: <br><span style="color: #5aa9d6">Ανταλλαγές:</span> η παράδοση των αντικειμένων από ολοκληρωμένες ανταλλαγές θα καθυστερήσει από το Steam μέχρι και 15 ημέρες <br><span style="color: #5aa9d6">Αγορά:</span> οι καταχωρήσεις πώλησης θα μπαίνουν σε αναμονή από το Steam πριν αναρτηθούν, για μέχρι και 15 ημέρες <br><br>Αυτό παρέχει στο χρήστη χρόνο να ακυρώσει κάθε εκκρεμή συναλλαγή που δεν εξουσιοδότησε. <br><br>Με την ακύρωση των εκκρεμών ανταλλαγών ή των ανταλλαγών σε αναμονή, ο λογαριασμός σας δεν θα μπορεί να ανταλλάξει για κάποιο χρονικό διάστημα ώστε να αποτραπούν περαιτέρω μη εξουσιοδοτημένες προσπάθειες κλοπής αντικειμένων. Δεν υπάρχει χρόνος αναμονής για ακυρώσεις αγγελιών στην αγορά κοινότητας.</div>' );

	description.append( '<div class="escrow_explanation_q">Απομάκρυνση της ανάγκης αναμονής των αντικειμένων</div>' );
	description.append( '<div class="escrow_explanation_a">Η χρήση του επαληθευτή κινητού διαβεβαιώνει ότι εσείς και μόνο εσείς μπορείτε να ανταλλάξετε ή να πουλήσετε τα αντικείμενά σας γρήγορα και με ασφάλεια, οπότε οι χρονικοί περιορισμοί δεν είναι πλέον απαραίτητοι. Αυξήστε την ασφάλεια του λογαριασμού σας με τη λήψη του <a href="https://store.steampowered.com/mobile/" target="_blank">επαληθευτή κινητού Steam Guard</a> για iOS ή Android συσκευές. </div>' );

	description.append( '<div class="escrow_explanation_a"><a href="http://store.steampowered.com/news/20631/" target="_blank">Διαβάστε την ανάρτηση του ιστολογίου Steam σχετικά με την ασφάλεια λογαριασμού</a> για μια λεπτομερή επεξήγηση του λόγου που επιβάλαμε τους χρονικούς περιορισμούς.</div>' );

	if ( bAddSteamGuardLink )
	{
		var dialog = ShowConfirmDialog(
			'Αναμονές ανταλλαγών και Αγοράς',
			description,
			'Μάθετε σχετικά με τον επαληθευτή κινητού Steam Guard',
			'Κλείσιμο'
		);
