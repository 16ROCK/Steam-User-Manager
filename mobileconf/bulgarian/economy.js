...
var CInventory = Class.create( {
		...
		for( var sCategoryName in this.tags )
		{
			...
			for( var index in rgCategoryTags )
			{
				...
				if ( ++cTagsDisplayed == 5 && cTagsTotal > 7 )
				{
					...
					elExpandTags.update( '+ Показване на още' );
	...
	BuildUnknownItemElement: function( appid, contextid, itemid )
	{
		...
		elItem.rgItem = { unknown: true, id: itemid, appid: this.appid, contextid: this.contextid, element: elItem, name: 'Неизвестен артикул ' + itemid, descriptions: [], fraudwarnings: [ 'Информацията за този артикул не може да бъде набавена.' ] };
			...
			if ( bUserAction )
			{
				...
				if ( $BtnAddToTrade.length && typeof OnDoubleClickItem != 'undefined' )
				{
					...
					if ( bInTrade )
					{
						...
						$BtnAddToTrade.children('span' ).text( 'Премахване от търговията' );
					}
					else
					{
						$BtnAddToTrade.removeClass('btn_grey_white_innerfade' ).addClass('btn_green_white_innerfade');
						$BtnAddToTrade.children('span' ).text( 'Добавяне към търговия' );
					}
	...
	LoadContexts: function( rgAppContextData )
	{
		for ( var appid in rgAppContextData )
		{
			...
			if ( rgContextIds.length > 1 )
			{
				...
				var templAllContextName = new Template( 'Всички #{appname} артикули');
	...
	OnInventoryLoadFailed: function( transport, appid, contextid )
	{
		...
		if ( transport.responseJSON && transport.responseJSON.busy )
		{
			if ( !elFailedInventory )
			{
				...
				alert( 'Този инвентар не е достъпен в момента. Моля, опитайте отново по-късно.' );
			}
		}
...
var g_rgEconomyDisplay = {"440":{"howtoget":"\u041c\u043e\u0436\u0435\u0442\u0435 \u0434\u0430 \u043f\u043e\u043b\u0443\u0447\u0438\u0442\u0435 \u0442\u0430\u043a\u0438\u0432\u0430, \u043a\u043e\u0438\u0442\u043e \u0441\u0435 \u043f\u0430\u0434\u0430\u0442 \u0431\u0435\u0437\u043f\u043b\u0430\u0442\u043d\u043e \u0432 \u0438\u0433\u0440\u0430\u0442\u0430, \u043e\u0442 \u041c\u0430\u043d\u043d \u041a\u043e \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0430 \u0438 \u043e\u0442 \u0442\u044a\u0440\u0433\u0443\u0432\u0430\u043d\u0435 \u0441 \u043f\u0440\u0438\u044f\u0442\u0435\u043b\u0438."},"620":{"howtoget":"\u041c\u043e\u0436\u0435\u0442\u0435 \u0434\u0430 \u0433\u0438 \u043f\u043e\u043b\u0443\u0447\u0430\u0432\u0430\u0442\u0435 \u043f\u0440\u0435\u0437 \u043d\u0430\u0448\u0438\u044f \u043c\u0430\u0433\u0430\u0437\u0438\u043d \u0432 Portal 2 \u0438\u043b\u0438 \u043f\u0440\u0438 \u0442\u044a\u0440\u0433\u0443\u0432\u0430\u043d\u0435 \u0441 \u043f\u0440\u0438\u044f\u0442\u0435\u043b\u0438."},"753":{"1":{"howtoget":"\u041c\u043e\u0436\u0435\u0442\u0435 \u0434\u0430 \u0441\u0435 \u0441\u0434\u043e\u0431\u0438\u0432\u0430\u0442\u0435 \u0441 \u0434\u043e\u043f\u044a\u043b\u043d\u0438\u0442\u0435\u043b\u043d\u0438 \u043a\u043e\u043f\u0438\u044f \u043d\u0430 \u0438\u0433\u0440\u0438 \u043f\u043e \u0432\u0440\u0435\u043c\u0435 \u043d\u0430 \u0441\u043f\u0435\u0446\u0438\u0430\u043b\u043d\u0438 \u043f\u0440\u043e\u043c\u043e\u0446\u0438\u0438. \u0418\u043b\u0438 \u043a\u0430\u0442\u043e \u0437\u0430\u043a\u0443\u043f\u0438\u0442\u0435 \u0438\u0433\u0440\u0430 \u043f\u0440\u0435\u0437 Steam \u043c\u0430\u0433\u0430\u0437\u0438\u043d\u0430, \u0438\u0437\u0431\u0438\u0440\u0430\u0439\u043a\u0438 \u201e\u041a\u0443\u043f\u0435\u0442\u0435 \u043a\u0430\u0442\u043e \u043f\u043e\u0434\u0430\u0440\u044a\u043a\u201c \u043f\u0440\u0438 \u0440\u0430\u0437\u043f\u043b\u0430\u0449\u0430\u043d\u0435\u0442\u043e."}},"99900":{"logo":"https:\/\/community.cloudflare.steamstatic.com\/public\/images\/economy\/applogos\/99900.png"},"99920":{"logo":"https:\/\/community.cloudflare.steamstatic.com\/public\/images\/economy\/applogos\/99900.png"}};
...
var HoverCurrencyFromTemplate = new Template( '<span style="#{currencystyle}">#{amount}</span> от #{contextname}');
...
function BuildHover( prefix, item, owner )
{
	...
	if ( elFraudWarnings )
	{
		...
		if ( item.fraudwarnings || ( g_bIsInventoryPage && item.is_currency ) )
		{
			...
			{
				var warning = $J( '<div/>' );
				warning.text( 'Това количество е лично и е видимо само от Вас.' );
...
function PopulateScrapAction( elActions, elScrapAmount, elScrapLink, item, appid, item_type, border_color )
{
	...
	$J.ajax({
		...
		success: function( response )
		{
			...
			{
				elScrapAmount.update( '%s скъпоценни камъни'.replace( /%s/, response.goo_value  ) );
...
function PopulateMarketActions( elActions, item )
{
	...
	if ( ( typeof(g_bViewingOwnProfile) != 'undefined' && g_bViewingOwnProfile ) || bIsTrading )
	{
		...
		elMarketLink.update( 'Преглед в обществения пазар' );
		...
		elPriceInfoContent.update( '<img src="https://community.cloudflare.steamstatic.com/public/images/login/throbber.gif" alt="Обработване…">' );
		...
		new Ajax.Request( 'https://steamcommunity.com/market/priceoverview/', {
				...
				onSuccess: function( transport ) {
					if ( transport.responseJSON && transport.responseJSON.success )
					{
						...
						{
							strInfo += 'Започва от: ' + transport.responseJSON.lowest_price + '<br>'
						}
						else
						{
							strInfo += 'Понастоящем няма достъпни обяви за този артикул.' + '<br>';
						}

						if ( transport.responseJSON.volume )
						{
							var strVolume = '%1$s продадени през последните 24 часа';
							strVolume = strVolume.replace( '%1$s', transport.responseJSON.volume );
							//strInfo += 'Средна цена: ' + transport.responseJSON.median_price + '<br>';
							strInfo += 'Количество: ' + strVolume + '<br>';
						}
		...
		if ( !bIsTrading )
		{
			var elSellButton = CreateMarketActionButton('green', 'javascript:SellCurrentSelection()', '	Продаване' );
...
function SellCurrentSelection()
{
	...
	{
		MessageDialog.Show(
			'Не можете да продавате артикули в обществения пазар, докато не <a href="https://store.steampowered.com/steamaccount/addfunds" target="_top">добавите средства в Steam портфейла си</a> или направите покупка в Steam магазина и потвърдите разплащателния си адрес.',
			'Артикулът не може да бъде продаден'
		);
	}
	else
	{
...
SellItemDialog = {
	...
	Show: function ( item ) {
		...
		$('market_sell_dialog_title').update( 'Обявете нещо за продажба' );
	...
	OnAccept: function( event ) {
		...
		{
			this.DisplayError( 'Трябва да се съгласите с „Условията за ползване на Steam“, за да продадете този артикул.' );
			return;
		}
		...
		if ( quantity < 1 || quantity > this.m_item.amount )
		{
			...
			this.DisplayError( 'Трябва да въведете валидно количество.' );
			return;
		}
		...
		if ( buyerPrice > g_rgWalletInfo['wallet_trade_max_balance'] || price > g_rgWalletInfo['wallet_trade_max_balance'] )
		{
			...
			var strError = ' Цената е по висока от максималната цена - %1$s.'
		...
		{
			$('market_sell_currency_input').style.borderColor = 'red';
			this.DisplayError( 'Трябва да въведете валидна цена.' );
			return;
		}
		...
		$('market_sell_dialog_title').update( 'Потвърдете цената за продажба' );
	...
	OnSuccess: function( transport ) {
		...
		if ( transport.responseJSON )
		{
			...
			if ( transport.responseJSON.requires_confirmation )
			{
				...
				{
					strText = 'С цел обявяването на този артикул в обществения пазар, трябва да го потвърдите в мобилното Ви Steam приложение. Това може да стане като пуснете приложението и се упътите към страницата за „Потвърждения“ от менюто.' +
							'<br><br>' +
							'Ако не виждате опцията „Потвърждения“ в главното меню на приложението, се уверете, че имате най-новата му версия.';

				}
				else
				{
					strText = 'С цел обявяването на този артикул в обществения пазар, трябва да завършите допълнителна стъпка за потвърждаване. Беше изпратено е-писмо до Вашата е-поща (завършваща на „%s“) с допълнителни инструкции.'.replace( /%s/, transport.responseJSON.email_domain );
				}

				ShowAlertDialog(
						'Необходимо е допълнително потвърждение',
						strText
				);
			}
			else
		...
		{
			this.DisplayError( 'Имаше проблем при публикуването на обявата за Вашия артикул. Опреснете страницата и опитайте отново.' );
		}
	},
...
function SelectItemDialogOnSelect()
{
	...
	{
		alert( 'Имаше проблем при запазването на избора Ви. Моля, опитайте отново по-късно.' );
	}
}
...
function CreatePriceHistoryGraph( line1, numYAxisTicks, strFormatPrefix, strFormatSuffix )
{
	var plot = $J.jqplot('pricehistory', [line1], {
		title:{text: 'Медиана за продажната цена', textAlign: 'left' },
		...
		highlighter: {
			...
			fadeTooltip: true,
            yvalues: 2,
            formatString: '<strong>%s</strong><br>%s<br>%d продадени'
		},
...
{
	var $Dialog = $J('<div/>');
	$Dialog.append( $J('<div/>', {'class': 'trade_scam_report_label' }).html( 'Използвайте това, с цел да докладвате %s до Steam поддръжката относно опит за измама.<br><br>Моля, предоставете кратко описание:'.replace( /%s/, strPersonaName ) ) );
	var $TextArea = $J('<textarea/>', {'rows': 3, 'cols': 26 });
	$Dialog.append( $J('<div/>', {'class': 'gray_bevel fullwidth' }).append( $TextArea ) );
	var Modal = ShowConfirmDialog( 'Докладване на измама', $Dialog, 'Докладване на измама').done( function() {
		if ( !$TextArea.val() )
		{
			ShowAlertDialog( 'Докладване на измама', 'Описанието е задължително.' );
			return;
		}
		...
		$J.post( 'https://steamcommunity.com/actions/ReportAbuse/', rgParams).done( function() {
			ShowAlertDialog( 'Благодарим Ви!', 'Докладът Ви беше подаден и ще бъде прегледан от Steam поддръжката.' );
		}).fail( function() {
			ShowAlertDialog( 'Докладване на измама', 'Имаше проблем при запазването на доклада Ви. Моля, опитайте отново по-късно.' );
		});
	} );
...
function ShowEscrowExplanationDialog( bAddSteamGuardLink )
{
	...
	description.append( '<div class="escrow_explanation_q">Какво е задържането на търговия или продажба?</div>' );
	description.append( '<div class="escrow_explanation_a">Това представлява времеви период, през който артикулите се задържат от Steam преди завършването на търговия или публикацията на обява в пазара.</div>' );

	description.append( '<div class="escrow_explanation_q">Задържането на артикули спомага при защитата на инвентара Ви</div>' );
	description.append( '<div class="escrow_explanation_a">Тъй като Steam акаунтите са ценни, особено ако разполагат с артикули, които си заслужава да бъдат откраднати. Ако не сте защитили акаунта си с физическо устройство (мобилният Steam Guard удостоверител), задържането на търговията ще Ви предостави време да откриете, че акаунтът е компрометиран. Това ще предотврати извличането на артикулите от акаунта Ви.</div>' );

	description.append( '<div class="escrow_explanation_q">Забавяне за улавяне и спиране на кражби на артикули</div>' );
	description.append( '<div class="escrow_explanation_a">Ако някой потребител, търгуващ или продаващ артикули, не е защитил акаунта си чрез мобилен удостоверител през последните 7 дни:<br><span style="color: #5aa9d6">&#10687; При търговии —</span> доставката на артикулите ще бъде забавена от Steam за до 15 дни;<br><span style="color: #5aa9d6">⦿ При продажби —</span> обявите за продажба ще бъдат задържани от Steam, преди да бъдат публикувани, за до 15 дни.<br><br>Това предоставя на потребителя време, през което да откаже всякакви висящи транзакции, както и всички други неупълномощени.<br><br>Отказването на такива, които са висящи или задържани, ще предизвика временно изчакване за търговии от акаунта Ви. Това е, с цел да се предотвратят по-нататъшни неупълномощени опити за търгуване на артикулите Ви. Няма временно изчакване за отказването на обяви от пазара.</div>' );

	description.append( '<div class="escrow_explanation_q">Премахнете нуждата за задържане на артикули</div>' );
	description.append( '<div class="escrow_explanation_a">Използването на мобилен удостоверител гарантира, че само и единствено Вие ще можете да търгувате или продавате артикулите си бързо и сигурно. Така ще премахнете необходимостта от задържания. Повишете сигурността на акаунта си, като се снабдите с <a title="Още информация относно мобилния Steam Guard удостоверител" href="https://store.steampowered.com/mobile/" target="_blank">мобилния Steam Guard удостоверител</a> за iOS и Android устройства. </div>' );

	description.append( '<div class="escrow_explanation_a"><a title="„Обновление за сигурността и търгуването“ в новинарския бюлетин на Steam" href="http://store.steampowered.com/news/20631/" target="_blank">Прочетете публикацията в Steam блога свързан със сигурността на акаунтите</a>, за по-подробно обяснение относно това защо въвеждаме задържанията.</div>' );

	if ( bAddSteamGuardLink )
	{
		var dialog = ShowConfirmDialog(
			'Задържания на търговии и продажби',
			description,
			'Научете за мобилния Steam Guard удостоверител',
			'Затваряне'
		);
