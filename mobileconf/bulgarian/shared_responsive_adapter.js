		...
		$SelectBox.append(
			$J('<option/>', {value: "bulgarian"} ).text( 'български' )
				...
				$J('<option/>', {value: "english"} ).text( 'English (английски)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "spanish"} ).text( 'Español — España (испански — Испания)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "latam"} ).text( 'Español — Latinoamérica (испански — Латинска Америка)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "turkish"} ).text( 'Türkçe (турски)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "vietnamese"} ).text( 'Tiếng Việt (виетнамски)' )
			);
					$SelectBox.append(
				$J('<option/>', {value: "ukrainian"} ).text( 'Українська (украински)' )
			);
