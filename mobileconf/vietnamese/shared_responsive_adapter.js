...
function Responsive_BuildChangeLanguageOption( $MenuItem )
{
	$MenuItem.click( function() {
		...
		$SelectBox.append(
			$J('<option/>', {value: "vietnamese"} ).text( 'Tiếng Việt' )
		);
					$SelectBox.append(
				...
				$J('<option/>', {value: "bulgarian"} ).text( 'Български (Bungari)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "czech"} ).text( 'Čeština (Séc)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "polish"} ).text( 'Polski (Ba Lan)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "portuguese"} ).text( 'Português (Bồ Đào Nha)' )
			);
					$SelectBox.append(
				...
				$J('<option/>', {value: "turkish"} ).text( 'Türkçe (Thổ Nhĩ Kỳ)' )
					...
					$SelectBox.append(
				$J('<option/>', {value: "ukrainian"} ).text( 'Українська (Ukrainia)' )
			);
